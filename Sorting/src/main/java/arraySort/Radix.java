 ...
 * Сортировка по основанию может выполняться с использованием различных вариантов,
 * таких как сортировка Least Significant Digit (LSD)
 * или сортировка Most Significant Digit (MSD).
